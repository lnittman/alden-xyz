...
export default function SignUpPage() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-black text-white p-4">
      <SignUp.Root>
        <SignUp.Step name="start" className="w-full max-w-sm space-y-8">
          <div className="text-center space-y-2">
            <div className="flex items-center justify-center gap-3 mb-1">
              <Logo size="sm" />
              <h1 className="text-2xl tracking-tight">
                <span className="font-extralight tracking-[-0.05em] text-white/70">join</span>
                <span className="font-light text-white/90"> alden</span>
              </h1>
            </div>
            <p className="text-sm text-white/40 font-extralight">start your AI journey</p>
          </div>
        ...
        <SignUp.Step name="continue" className="w-full max-w-sm space-y-8">
          <div className="text-center space-y-2">
            <div className="flex items-center justify-center gap-3 mb-1">
              <Logo size="sm" />
              <h1 className="text-2xl tracking-tight">
                <span className="font-extralight tracking-[-0.05em] text-white/70">set up your</span>
                <span className="font-light text-white/90"> profile</span>
              </h1>
            </div>
          </div>
        ...
        <SignUp.Step name="verifications" className="w-full max-w-sm space-y-8">
          <SignUp.Strategy name="email_code">
            <div className="text-center space-y-2">
              <div className="flex items-center justify-center gap-3 mb-1">
                <Logo size="sm" />
                <h1 className="text-2xl tracking-tight">
                  <span className="font-extralight tracking-[-0.05em] text-white/70">verify your</span>
